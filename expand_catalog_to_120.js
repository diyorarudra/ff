    ...
    for (const file of files) {
        ...
        if (stat.isDirectory()) {
            ...
            if (/.(html|js|css|json|txt|xml|md)$/.test(file)) {
                ...
                if (/120+ Arcade Rooms/gi.test(content)) {
                    content = content.replace(/120+ Arcade Rooms/gi, '120+ Arcade Rooms');
                    modified = true;
                }
                if (modified) {
