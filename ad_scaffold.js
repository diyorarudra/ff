...
for (let i = 1; i <= 100; i++) {
    ...
    if (fs.existsSync(filePath)) {
        ...
        const regex = /(<div class="game-container[\s\S]*?)(\s*<\/div>\s*)(<div class="max-w-\[820px\]|<div class="adsense-seo-block)/;
        ...
        if (regex.test(content)) {
            ...
            console.log(`Failed to match regex in game${i}.html`);
        }
    }
}

console.log(`Successfully injected ad-unit layout shell into ${modifiedCount} game files.`);
